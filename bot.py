...
def get_admission_plan(uni, data):
    ...
    country_plans = {
        ...
        "Венгрия": "☐ Мотивационное письмо\n☐ Аттестат + апостиль\n" + ("☐ Stipendium Hungaricum (дедлайн январь)\n" if "Stipendium" in scholarship else "") + "\n*После зачисления:*\n☐ Студенческая виза\n",
        "Чехия": "☐ Нострификация аттестата\n☐ Мотивационное письмо\n\n*После зачисления:*\n☐ Студенческая виза\n",
        "Сербия": "☐ Перевод аттестата на сербский\n☐ Справка об отсутствии судимости\n" + ("\n✅ *Виза не нужна для РФ!*\n" if is_rf else ""),
        "Грузия": "☐ Перевод аттестата\n☐ Мотивационное письмо\n" + ("\n✅ *Виза не нужна для РФ!*\n" if is_rf else ""),
        "Турция": "☐ Аттестат + апостиль\n☐ Мотивационное письмо\n" + ("☐ Türkiye Scholarships (дедлайн февраль)\n" if "Türkiye" in scholarship else "") + "\n*После зачисления:*\n☐ Студенческая виза\n",
        "Китай": "☐ Аттестат + апостиль\n☐ Медицинская справка\n☐ Мотивационное письмо\n" + ("☐ CSC стипендия (дедлайн март)\n" if "CSC" in scholarship else "") + "\n*После зачисления:*\n☐ Виза X1\n",
        "Южная Корея": "☐ Аттестат + апостиль\n☐ Мотивационное письмо\n" + ("☐ GKS стипендия (дедлайн март)\n" if "GKS" in scholarship else "") + "\n*После зачисления:*\n☐ Виза D-2\n",
        "Нидерланды": "☐ Аттестат + апостиль\n☐ Мотивационное письмо\n☐ Подача через Studielink\n\n*После зачисления:*\n☐ Виза MVV\n",
    ...
    plan += f"\n⚠️ _Дедлайн: {uni['deadline']}_\n\n✅ Сохрани этот план!"
    return plan

EMPLOYMENT_BY_COUNTRY = {
    "Германия": {"score": "⭐⭐⭐⭐⭐", "visa": "Blue Card — лёгкий путь к ПМЖ", "salary": "€40,000–70,000/год", "market": "Острая нехватка специалистов", "stay": "18 месяцев на поиск работы"},
    "Нидерланды": {"score": "⭐⭐⭐⭐⭐", "visa": "Orientation Year Visa — 1 год", "salary": "€35,000–60,000/год", "market": "Сильный IT, финансы, логистика", "stay": "12 месяцев после диплома"},
    "Чехия": {"score": "⭐⭐⭐⭐", "visa": "Рабочая виза ЕС", "salary": "€20,000–35,000/год", "market": "Растущий IT-рынок", "stay": "9 месяцев на поиск работы"},
    "Венгрия": {"score": "⭐⭐⭐", "visa": "Рабочая виза ЕС", "salary": "€15,000–25,000/год", "market": "Небольшой рынок", "stay": "Можно остаться в ЕС"},
    "Австрия": {"score": "⭐⭐⭐⭐⭐", "visa": "Красно-бело-красная карта", "salary": "€35,000–60,000/год", "market": "Высокий уровень жизни", "stay": "12 месяцев на поиск работы"},
    "Сербия": {"score": "⭐⭐⭐", "visa": "Рабочая виза (не ЕС)", "salary": "€10,000–20,000/год", "market": "Растущий IT-сектор", "stay": "База для переезда в ЕС"},
    "Грузия": {"score": "⭐⭐⭐", "visa": "Без визы для РФ", "salary": "€8,000–15,000/год", "market": "Удобная база для бизнеса", "stay": "Хорошо для удалённой работы"},
    "Турция": {"score": "⭐⭐⭐⭐", "visa": "Рабочий ВНЖ", "salary": "€12,000–25,000/год", "market": "Растущая экономика, стартапы", "stay": "Активная сцена в Стамбуле"},
    "Китай": {"score": "⭐⭐⭐⭐", "visa": "Рабочая виза Z", "salary": "€15,000–40,000/год", "market": "Огромный рынок", "stay": "Знание языка открывает все двери"},
    "Южная Корея": {"score": "⭐⭐⭐⭐", "visa": "D-10 после учёбы", "salary": "€20,000–45,000/год", "market": "Samsung, LG, Hyundai", "stay": "6 месяцев на поиск работы"},
    "США": {"score": "⭐⭐⭐⭐⭐", "visa": "OPT — 1-3 года после учёбы", "salary": "$60,000–120,000/год", "market": "Лучший рынок для IT и науки", "stay": "OPT + H-1B виза"},
    "Великобритания": {"score": "⭐⭐⭐⭐⭐", "visa": "Graduate Route — 2 года", "salary": "£30,000–60,000/год", "market": "Лондон — финансовый центр", "stay": "2 года без ограничений"},
    "Польша": {"score": "⭐⭐⭐", "visa": "Рабочая виза ЕС", "salary": "€15,000–25,000/год", "market": "Растущий IT-рынок", "stay": "9 месяцев на поиск работы"},
    "Финляндия": {"score": "⭐⭐⭐⭐", "visa": "Job-seeker visa — 1 год", "salary": "€30,000–50,000/год", "market": "Nokia, Rovio — сильный tech", "stay": "12 месяцев на поиск работы"},
    "Эстония": {"score": "⭐⭐⭐⭐", "visa": "Job-seeker visa", "salary": "€20,000–40,000/год", "market": "Цифровая страна — Skype, Wise", "stay": "9 месяцев на поиск работы"},
    "Казахстан": {"score": "⭐⭐⭐", "visa": "Не нужна для СНГ", "salary": "€10,000–20,000/год", "market": "Растущая экономика", "stay": "Легко для граждан СНГ"},
    "Армения": {"score": "⭐⭐⭐", "visa": "Без визы для РФ", "salary": "€8,000–18,000/год", "market": "Растущий IT-сектор", "stay": "База для удалённой работы"},
    "ОАЭ": {"score": "⭐⭐⭐⭐⭐", "visa": "Рабочая виза", "salary": "$40,000–100,000/год (без налогов!)", "market": "Финансы, логистика, tech", "stay": "Продление через работодателя"},
    "Израиль": {"score": "⭐⭐⭐⭐", "visa": "Рабочая виза", "salary": "$30,000–80,000/год", "market": "Стартап-нация, топ IT", "stay": "Высокий спрос на специалистов"},
    "Испания": {"score": "⭐⭐⭐⭐", "visa": "EU Blue Card", "salary": "€20,000–40,000/год", "market": "Туризм, IT, финансы", "stay": "12 месяцев на поиск работы"},
}
...
def stop_cmd(message):
    ...
    user_data[message.chat.id] = {}
    WAITING_FOR_UNI_SEARCH.discard(message.chat.id)
    bot.send_message(message.chat.id, "Остановлено. Возвращаю в главное меню!", reply_markup=main_menu_markup())
...
def show_stats(message):
    ...
    response += "\n\n⚠️ _Сбрасывается при перезапуске. Постоянные данные — в Google Sheets._"
...
def ask_grade_or_status(message):
    ...
    if message.text == "До 18":
        markup.add("8 класс", "9 класс"); markup.add("10 класс", "11 класс"); markup.add("Другое")
...
def ask_gpa(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("⭐⭐⭐⭐⭐ Отлично (4.5–5)"); markup.add("⭐⭐⭐⭐ Хорошо (3.5–4.5)"); markup.add("⭐⭐⭐ Удовлетворительно")
...
def process_achievements_detail(message):
    ...
    response = "🎯 *Анализ твоих достижений:*\n\n" + "\n\n".join(analysis) + "\n\n💡 _Упомяни всё в мотивационном письме!_"
    bot.send_message(message.chat.id, response, parse_mode="Markdown")
    ask_english(message)
...
def ask_visa(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("➖ Нет опыта", "✈️ Туристические"); markup.add("🎓 Студенческие", "⚠️ Были отказы")
...
def ask_personality(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("🧩 Интроверт"); markup.add("🌟 Экстраверт"); markup.add("⚖️ Посередине")
...
def ask_stress(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("💡 Ищу решение", "🤝 Прошу помощи"); markup.add("🎮 Отвлекаюсь", "🔒 Замыкаюсь")
...
def ask_leadership(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("🦁 Беру инициативу"); markup.add("🤝 Поддерживаю команду"); markup.add("🎯 Работаю самостоятельно")
...
def ask_goal(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("🌍 Остаться за рубежом"); markup.add("🏠 Вернуться домой"); markup.add("🤷 Пока не знаю")
...
def ask_career(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("💻 IT / Стартап", "🏢 Корпорация"); markup.add("🚀 Своё дело", "🔬 Наука"); markup.add("🌱 Социальные проекты")
...
def ask_priority(message):
    ...
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("🏆 Рейтинг вуза", "💰 Стоимость"); markup.add("🌍 Страна", "💼 Трудоустройство")
...
def ask_budget(message):
    ...
    markup.add("🧡 До €15,000 в год"); markup.add("❤️ Бюджет не ограничен")
...
def expand_budget(message):
    markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    markup.add("💛 До €5,000 в год"); markup.add("🧡 До €15,000 в год"); markup.add("❤️ Бюджет не ограничен")
...
def quick_show_filtered(chat_id, field_filter=None, main_field=None, country_filter=None, cost_filter=None, scholarship_filter=False):
    ...
    for uni in UNIVERSITIES:
        ...
        if country_filter and normalize(country_filter) not in normalize(uni["country"]): continue
        if cost_filter and normalize(uni["cost"]) != normalize(cost_filter): continue
        if scholarship_filter and (not uni["scholarship"].strip() or uni["scholarship"].strip() == "Нет"): continue
        results.append(uni)
    ...
    if not results:
        ...
        bot.send_message(chat_id, f"Не нашла университетов по *{label}* 😔\n\nПопробуй другой фильтр!", parse_mode="Markdown", reply_markup=markup)
        return
...
def show_comparison(message):
    ...
    fields_to_compare = [
        ...
        ("🗣️ Язык", "language"), ("📝 IELTS", "ielts"), ("📅 Дедлайн", "deadline"),
        ("⏱ Длительность", "duration"), ("🏠 Жильё", "housing"), ("✍️ Экзамены", "exams"),
    ]
...
def clear_comparison(message):
    user_data[message.chat.id]["compare_list"] = []
    bot.send_message(message.chat.id, "Список сравнения очищен!", reply_markup=main_menu_markup())

@bot.message_handler(func=lambda m: m.chat.id in WAITING_FOR_UNI_SEARCH and m.text and not m.text.startswith("/") and m.text not in SKIP_TEXTS and not m.text.startswith("📅") and not m.text.startswith("📋 Чеклист для"))
def handle_university_search(message):
    ...
    markup.add("⚖️ Сравнить с другим")
